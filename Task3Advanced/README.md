...
```
Добавил в архитектуру интсрументы инфраструктуры:
  - Platform Services - мониторинг, логи, трейсинг, секурити
  - Batch/ETL слой для исторических загрузок и переобработки данных
  - observability и секурити на схеме С4
  - описание ETL 
```
...
- Batch Processing / ETL
  ...
  - используется также для переобработки данных (reprocessing) при изменении логики
  - загрузка исторических данных (backfill)
  - сложные трансформации вне стриминга
  - используем
    - Apache Airflow
    - Apache Spark
...
- Platform Services
  ...
  - обеспечивают наблюдаемость, безопасность и эксплуатацию
